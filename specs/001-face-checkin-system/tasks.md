...
- [ ] T026 [US2] Create face-photo schema migration in `backend/src/main/resources/db/migration/V2__face_photo_refs.sql` (Depends on: T022; Accept: `face_photo` and `huawei_face_ref` tables, indexes, user foreign keys, and status columns match the approved data model).
